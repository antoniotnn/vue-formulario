            ...
            <div class="col-6 bg-light">
                ...
                <div>
                    <div class="mb-3 row">
                        ...
                        <!-- Modificadores do v-model: number, trim e lazy. Exemplo; form.trim.nome, form.lazy.nome, form.number.nome (OBS: modificadores podem ser encadeados) -->
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            ...
                            <!-- obs: no vue 2, se o input for number, o dado é recebido como string. Entao no vue 2, é interessante usar o modificador.number no v-model para assegurar que o atrr conectado ao input de fato receba um number.-->
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <input-estrelas :numero-estrelas="5" /> <!-- Se o bind não for feito, isto é se o numero-estrelas estiver sem os : (dois pontos) na frente, o que o vue passará para o componente será String e não um number. Por isso que o bind está sendo usado. E para passar String usando o bind, a sintaxe ficaria assim:  :numero-estrelas="'4'" -->
                        </div>
                    </div>
                    <hr>
                    <div class="mb-3 row">
